  ...
  return (
        <div>
            <div className='relative flex items-center w-[48px] h-[40px] border-1 rounded-sm z-2'>
              ...
              <div 
                className={`z-1 w-[50%] h-full fixed top-0 right-0 text-white flex justify-center items-center transition-transform duration-300 ease-in-out bg-[#000000b3] ${isOpen ? 'translate-x-[0]' : 'translate-x-[100%]'}`}
              >
                <ul
